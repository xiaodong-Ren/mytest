...
if __name__ == '__main__':
    ...
    parents = initial_population(p_size,parameter_num,parameter_lower_bound,parameter_upper_bound)
    children = set()

    for it in range(1,iteration+1):
        all_population = parents | children#并集
        ...
        print('best_parameter:',parameter,'best_target:',best,' mean_target:',mean)
